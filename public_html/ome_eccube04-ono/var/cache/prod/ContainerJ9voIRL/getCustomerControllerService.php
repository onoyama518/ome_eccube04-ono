...
class getCustomerControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.81O.WAo'] ?? $container->load('get_ServiceLocator_81O_WAoService'))->withContext('Eccube\\Controller\\Admin\\Customer\\CustomerController', $container));
