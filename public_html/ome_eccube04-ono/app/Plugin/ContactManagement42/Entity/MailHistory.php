...
if (!class_exists('\Plugin\ContactManagement42\Entity\MailHistory')) {
    /**
     * MailHistory
     *
    ...
    class MailHistory extends AbstractEntity
    {
        ...
        /**
         * @var \Plugin\ContactManagement42\Entity\ContactReply
         *
         * @ORM\ManyToOne(targetEntity="Plugin\ContactManagement42\Entity\ContactReply")
         * @ORM\JoinColumns({
         ...
         *
         * @ORM\ManyToOne(targetEntity="Plugin\ContactManagement42\Entity\Contact")
         * @ORM\JoinColumns({
