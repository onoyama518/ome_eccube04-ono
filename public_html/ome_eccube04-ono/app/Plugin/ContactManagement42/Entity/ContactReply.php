 ...
 * @ORM\Entity(repositoryClass="Plugin\ContactManagement42\Repository\ContactReplyRepository")
 */
class ContactReply extends \Eccube\Entity\AbstractEntity
{
    ...
    /**
     * @var \Plugin\ContactManagement42\Entity\Contact
     *
     * @ORM\ManyToOne(targetEntity="Plugin\ContactManagement42\Entity\Contact", inversedBy="ContactReplies")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugin\ContactManagement42\Entity\MailHistory", mappedBy="ContactReply", cascade={"remove"})
     * @ORM\OrderBy({
     *     "send_date"="DESC"
     * })
     */
