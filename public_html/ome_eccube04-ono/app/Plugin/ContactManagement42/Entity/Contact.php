 ...
 * @ORM\Entity(repositoryClass="Plugin\ContactManagement42\Repository\ContactRepository")
 */
class Contact extends \Eccube\Entity\AbstractEntity
{
    ...
    /**
     * @var \Plugin\ContactManagement42\Entity\ContactStatus
     *
     * @ORM\ManyToOne(targetEntity="\Plugin\ContactManagement42\Entity\ContactStatus")
     * @ORM\JoinColumns({
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugin\ContactManagement42\Entity\ContactReply", mappedBy="Contact", cascade={"persist"})
     * @ORM\OrderBy({
     *    "reply_date"="DESC"
     * })
     */
