 ...
 * All rights reserved.
 */
namespace Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\system;

use Eccube\Common\EccubeConfig;
use Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\util\Encoder;
use Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\entity\ResponseDataFactory;
use Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\util\HttpsRequestSender;
use Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\util\PaygentB2BModuleLogger;
use Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\util\StringUtil;
...
class PaygentB2BModule {
    ...
    function init() {
        ...
        if ($this->masterFile == null
            || strcasecmp(get_class($this->masterFile), "Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\system\PaygentB2BModuleResources") != 0) {
            // エラーコード
            return $this->masterFile;
        }

        if ($this->logger == null
            || strcasecmp(get_class($this->logger), "Plugin\PaygentPayment42\jp\co\ks\merchanttool\connectmodule\util\PaygentB2BModuleLogger") != 0) {
            // エラーコード
            return $this->logger;
        }
