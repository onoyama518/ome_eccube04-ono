...
namespace Plugin\PaygentPayment42\Entity;
 ...
 * @ORM\Entity(repositoryClass="Plugin\PaygentPayment42\Repository\ConfigRepository")
 */
class Config
{
    /**
    ...
    /**
     * モジュール型 Attemptオーソリ制御区分
     * @var int
     *
     * @ORM\Column(name="attempt_auth_kbn", type="integer", options={"unsigned":true}, nullable=true)
     */
    private $attempt_auth_kbn;
     ...
     * @var int
     *
     * @ORM\Column(name="conveni_connect_type", type="integer", options={"unsigned":true}, nullable=true)
     */
    private $conveni_connect_type;
     ...
     * @return string
     */
    public function getAttemptAuthKbn()
    {
        return $this->attempt_auth_kbn;
    }

    /**
     * Attemptオーソリ制御区分
     * @param string $attempt_auth_kbn
     *
     * @return $this
     */
    public function setAttemptAuthKbn($attempt_auth_kbn)
    {
        $this->attempt_auth_kbn = $attempt_auth_kbn;
     ...
     * @return string
     */
    public function getConveniConnectType()
    {
        return $this->conveni_connect_type;
    }

    /**
     * コンビニ決済 接続タイプ
     * @param string $conveni_connect_type
     *
     * @return $this
     */
    public function setConveniConnectType($conveni_connect_type)
    {
        $this->conveni_connect_type = $conveni_connect_type;
