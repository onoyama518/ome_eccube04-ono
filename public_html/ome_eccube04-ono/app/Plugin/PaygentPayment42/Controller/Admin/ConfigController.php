...
use Plugin\PaygentPayment42\Service\ConfigService;
...
class ConfigController extends AbstractController
{
    ...
    /**
     * モジュール設定画面の画面表示クラス
     * @Route("/%eccube_admin_route%/paygent_payment/config", name="paygent_payment42_admin_config")
     * @Template("@PaygentPayment42/admin/config.twig")
     */
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($ret['resultStatus'] === $this->eccubeConfig['paygent_payment']['result_success']) {
                ...
                return $this->redirectToRoute('paygent_payment42_admin_config');
            } else {
        ...
        return $this->render('@PaygentPayment42/admin/config.twig', $arrReturn, $response);
    }
