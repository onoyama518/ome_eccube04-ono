...
class FileController extends AbstractController
{
     ...
     * @Template("@PaygentPayment42/admin/Setting/System/file.twig")
     */
    public function index(Request $request)
    {
        ...
        // PluginData/PaygentPayment42/配下のファイル一覧取得
        ...
        return $this->render('@PaygentPayment42/admin/Setting/System/file.twig', $arrReturn, $response);
    }
