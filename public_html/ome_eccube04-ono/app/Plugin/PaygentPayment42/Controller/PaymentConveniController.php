...
use Plugin\PaygentPayment42\Form\Type\ConveniPaymentType;
use Plugin\PaygentPayment42\Repository\ConfigRepository;
use Plugin\PaygentPayment42\Service\Conveni\ConveniTypeF;
use Plugin\PaygentPayment42\Service\Conveni\FrontConveniService;
use Plugin\PaygentPayment42\Service\Error\ErrorDetailMsg;
...
class PaymentConveniController extends AbstractController
{
     ...
     * @param ConveniTypeF $conveniTypeF
     */
     ...
     * @Template("@PaygentPayment42/default/payment_conveni.twig")
     */
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($ret['resultStatus'] === $this->eccubeConfig['paygent_payment']['result_success']) {
                ...
                if ($config->getConveniConnectType() === $this->eccubeConfig['paygent_payment']['cvs_connect_type']['f']) {
                    $arrConfirmMessage = $this->conveniTypeF->getPaymentParams($formParams['cvs_company_id'], $phoneNumber);
                } else {
        ...
        return $this->render('@PaygentPayment42/default/payment_conveni.twig', $arrReturn, $response);
    }
