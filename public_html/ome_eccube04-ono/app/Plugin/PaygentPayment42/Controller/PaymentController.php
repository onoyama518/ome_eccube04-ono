...
use Plugin\PaygentPayment42\Service\PaygentDifferenceNotice;
...
class PaymentController extends AbstractController
{
    ...
    public function differenceNotice() {
        try {
            ...
            logs('paygent_payment')->error("An exception occurred. result = 0 " . $e->getMessage());
            $result = 0;
        }
     ...
     * @Template("@PaygentPayment42/default/Shopping/shopping_error.twig")
     */
    function errorPage() {
    ...
    function shoppingComplete(Request $request) {
        ...
        $order = $this->orderRepository->findOneBy([
            ...
            'OrderStatus' => [OrderStatus::PENDING, OrderStatus::NEW, OrderStatus::PAID],
