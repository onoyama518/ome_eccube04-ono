...
use Plugin\PaygentPayment42\Form\Type\PaidyPaymentType;
use Plugin\PaygentPayment42\Repository\ConfigRepository;
use Plugin\PaygentPayment42\Service\Paidy\FrontPaidyService;
...
class PaymentPaidyController extends AbstractController
{
     ...
     * @Template("@PaygentPayment42/default/payment_paidy.twig")
     */
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if (count($shippings) > 1) {
                ...
                return $this->render('@PaygentPayment42/default/payment_paidy.twig', $arrReturn, $response);
            }
            ...
            return $this->render('@PaygentPayment42/default/payment_paidy_checkout.twig', $arrReturn, $response);
        }
    ...
    public function checkout(Request $request)
    {
        ...
        $order = $this->orderRepository->findOneBy([
           ...
           'OrderStatus' => [OrderStatus::PENDING, OrderStatus::NEW],
