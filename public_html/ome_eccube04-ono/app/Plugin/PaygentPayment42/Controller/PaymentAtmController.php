...
use Plugin\PaygentPayment42\Form\Type\ATMPaymentType;
use Plugin\PaygentPayment42\Service\Atm\FrontAtmService;
...
class PaymentAtmController extends AbstractController
{
     ...
     * @Template("@PaygentPayment42/default/payment_atm.twig")
     */
    public function index(Request $request)
    {
        ...
        return $this->render('@PaygentPayment42/default/payment_atm.twig', $arrReturn, $response);
    }
