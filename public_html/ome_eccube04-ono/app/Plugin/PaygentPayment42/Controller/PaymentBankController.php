...
use Plugin\PaygentPayment42\Form\Type\BankPaymentType;
use Plugin\PaygentPayment42\Service\Bank\FrontBankService;
use Plugin\PaygentPayment42\Service\Error\ErrorDetailMsg;
use Plugin\PaygentPayment42\Service\PaygentRecoverCartService;
...
class PaymentBankController extends AbstractController
{
    ...
    public function aspComplete(Request $request)
    {
        ...
        $order = $this->orderRepository->findOneBy([
            ...
            'OrderStatus' => [OrderStatus::PENDING, OrderStatus::PAID],
            'pre_order_id' => $preOrderId
        ]);
     ...
     * @Template("@PaygentPayment42/default/payment_bank.twig")
     */
    public function index(Request $request)
    {
        ...
        return $this->render('@PaygentPayment42/default/payment_bank.twig', $arrReturn, $response);
    }
