...
use Plugin\PaygentPayment42\Form\Type\CareerPaymentType;
use Plugin\PaygentPayment42\Service\Career\FrontCareerService;
...
class PaymentCareerController extends AbstractController
{
     ...
     * @Template("@PaygentPayment42/default/payment_career.twig")
     */
    public function index(Request $request)
    {
        ...
        return $this->render('@PaygentPayment42/default/payment_career.twig', $arrReturn, $response);
    }
