...
class PaygentBaseService {
    ...
    public function sendStatusAlertMailToAdmin($arrParam) {
        ...
        $body = $this->twig->render("@PaygentPayment42/admin/status_alert_mail.twig", [
        ...
        $message = (new Email())
            ->subject('['.$this->baseInfo->getShopName().'] ' . $this->eccubeConfig['paygent_payment']['status_alert_mail_title'])
