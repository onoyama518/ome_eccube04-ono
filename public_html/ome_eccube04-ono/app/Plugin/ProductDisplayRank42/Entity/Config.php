...
namespace Plugin\ProductDisplayRank42\Entity;
 ...
 * Config
 *
 * @ORM\Table(name="plg_product_display_rank42_config")
 * @ORM\Entity(repositoryClass="Plugin\ProductDisplayRank42\Repository\ConfigRepository")
 */
class Config
{
