...
### �N���C�A���g�ؖ����t�@�C���p�X ###
paygentB2Bmodule.client_file_path=public_html/ome/ec2/app/PluginData/PaygentPayment42/Mdev-20130909_client_cert.pem

### Trusted Server Certificate ###
### �F�؍ς݂�CA�t�@�C���p�X   ###
paygentB2Bmodule.ca_file_path=public_html/ome/ec2/app/PluginData/PaygentPayment42/curl-ca-bundle.crt
...
### Program Log File     ###
### ���O�t�@�C���o�̓p�X ###
paygentB2Bmodule.log_output_path=public_html/ome/ec2/var/log/prod/connectmodule.log
